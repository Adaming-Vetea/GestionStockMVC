					...
					<div class="p-5">
						<div class="text-center">
							<h1 class="h4 text-gray-900 mb-4">
								<fmt:message key="salaries.ajouter" />
							</h1>
						</div>
						<c:url value="/salarie/enregistrer" var="urlEnregistrer" />
						<f:form modelAttribute="salarie" action="${urlEnregistrer}"
							method="post">
							<f:hidden path="id" />
							<div class="form-group row">
								...
								<f:input type="text" path="nom"
									class="form-control form-control-user" placeholder="Nom" />



								<label><fmt:message key="common.prenom" /></label>
								<f:input type="text" path="prenom"
									class="form-control form-control-user" placeholder="prenom" />


								<label><fmt:message key="common.numSecu" /></label>
								<f:input type="number" path="numSecu"
									class="form-control form-control-user" placeholder="numSecu" />
							...
							<a href="${pageContext.servletContext.contextPath}/salarie"
								class="btn btn-danger btn-user btn-block"><i
								class="fa fa-save">Annuler</i></a>
